...
const NOM_VERS_SLUG: Record<string, string> = {
  ...
  'Senlis':                 'vtc-senlis',
  'Creil':                  'vtc-creil',
  'Saint-Maximin':          'vtc-saint-maximin',
  ...
  'Noyon':                  'vtc-noyon',
  'Goussainville':          'vtc-goussainville',
  'Louvres':                'vtc-goussainville',
  'Fosses':                 'vtc-goussainville',
...
const DESTINATIONS: Record<string, {
  ...
  'vtc-saint-maximin': {
    slug: 'vtc-saint-maximin',
    title: 'VTC Saint-Maximin & Environs',
    metaTitle: 'VTC Saint-Maximin → CDG, Orly, Paris dès 59€ | Owise',
    metaDesc: 'Chauffeur VTC depuis Saint-Maximin (60740) vers CDG, Orly, Beauvais et Paris. Tarif fixe dès 59€, disponible 24h/24. Réservation en ligne en 30 secondes.',
    keywords: [
      'vtc saint-maximin','vtc saint-maximin cdg','chauffeur privé saint-maximin',
      'taxi saint-maximin aéroport','vtc saint-maximin orly','vtc 60740',
      'vtc saint-maximin creil','vtc saint-maximin gouvieux','chauffeur privé 60740',
      'taxi saint-maximin paris',
    ],
    ...
    zones: [
      ...
      { nom: 'Villers-Saint-Paul', cp: '60870', km: 2.5 },
      { nom: 'Gouvieux', cp: '60270', km: 3.1 },
      { nom: 'Montataire', cp: '60160', km: 3.5 },
      { nom: 'Creil', cp: '60100', km: 3.6 },
      { nom: 'Saint-Leu-d\'Esserent', cp: '60340', km: 4.0 },
      { nom: 'Nogent-sur-Oise', cp: '60180', km: 4.5 },
      { nom: 'Chantilly', cp: '60500', km: 6.0 },
      { nom: 'Lamorlaye', cp: '60260', km: 8.5 },
    ],
    faq: [
  ...
  'vtc-aeroport-beauvais': {
    ...
    metaTitle: 'VTC Aéroport Beauvais-Tillé (BVA) dès 69€ — Tarif Fixe | Owise',
    ...
    faq: [
      { q: 'Quel est le tarif depuis Creil vers l\'aéroport de Beauvais ?', a: 'Le forfait Creil → Beauvais-Tillé est de 69€ en berline, prix fixe garanti. Depuis Chantilly, le tarif est identique : 69€. Depuis Senlis ou Compiègne, obtenez votre prix exact avec notre estimateur en ligne.' },
      ...
      { q: 'Desservez-vous l\'aéroport de Beauvais depuis Paris ?', a: 'Oui. Depuis Paris intramuros, le forfait vers Beauvais-Tillé est de 139€ en berline, prix fixe garanti. L\'aéroport est desservi depuis tout l\'IDF et l\'Oise.' },
  ...
  'vtc-beauvais': {
    slug: 'vtc-beauvais',
    title: 'VTC Beauvais — Chauffeur Privé',
    metaTitle: 'VTC Beauvais → CDG, Orly, Paris dès 69€ | Owise',
    metaDesc: 'Chauffeur VTC depuis Beauvais (60000) vers CDG, Orly, Paris, Chantilly et Creil. Tarif fixe garanti, disponible 24h/24. Réservation en ligne en 30 secondes.',
    keywords: [
      'vtc beauvais','chauffeur privé beauvais','vtc beauvais cdg','vtc beauvais paris',
      'taxi beauvais','vtc beauvais orly','chauffeur beauvais 60000','vtc oise beauvais',
      'vtc beauvais chantilly','vtc beauvais creil',
    ],
    ...
    faq: [
      ...
      { q: 'Quel est le tarif vers Orly depuis Beauvais ?', a: 'Le forfait Beauvais → Orly est de 169€ en berline, prix fixe garanti. Orly étant plus au sud, le trajet est un peu plus long que vers CDG.' },
      { q: 'Desservez-vous Beauvais vers Chantilly ou Creil ?', a: 'Oui, pour 69€ en berline vers Chantilly ou Creil, prix fixe garanti — pratique pour rejoindre une gare ou une correspondance dans l\'Oise Sud.' },
      { q: 'Peut-on réserver un VTC à Beauvais tôt le matin ou tard le soir ?', a: 'Oui, nous sommes disponibles 24h/24, 7j/7. Pour les départs avant 6h ou après 22h, le supplément nuit (+20%) s\'applique automatiquement et est inclus dans votre estimation.' },
      { q: 'Cette page concerne-t-elle aussi l\'aéroport de Beauvais-Tillé ?', a: 'Pour un vol au départ ou à l\'arrivée de Beauvais-Tillé (BVA), consultez notre page dédiée VTC Aéroport Beauvais-Tillé avec suivi de vol en temps réel.' },
    ],
  },
  'vtc-lamorlaye': {
    slug: 'vtc-lamorlaye',
  ...
  // Secteur cree le 2026-09-21 (zone RPF « Roissy Pays de France »). 21 communes,
  // 83 806 habitants, toutes plus proches de CDG que Chantilly. Distances et
  // durees ci-dessous mesurees par la route via Google, pas estimees.
  'vtc-goussainville': {
    slug: 'vtc-goussainville',
    title: 'VTC Goussainville & Roissy Pays de France',
    metaTitle: 'VTC Goussainville, Louvres, Fosses → CDG 59€ fixe | Owise',
    metaDesc: 'Chauffeur VTC depuis Goussainville, Louvres, Fosses, Marly-la-Ville et le Roissy Pays de France. CDG à 59€ en tarif fixe, 12 à 18 minutes. Disponible 24h/24.',
    keywords: [
      'vtc goussainville','vtc goussainville cdg','taxi goussainville aéroport',
      'vtc louvres cdg','vtc fosses 95','vtc survilliers cdg','vtc marly-la-ville',
      'vtc saint-witz','vtc vémars','chauffeur privé roissy pays de france',
      'vtc 95190 cdg','vtc puiseux-en-france','vtc plailly cdg',
    ],
    h1: 'VTC Goussainville & Roissy Pays de France',
    intro: 'Votre chauffeur VTC depuis Goussainville, Louvres, Fosses, Survilliers, Marly-la-Ville, Saint-Witz, Vémars et toutes les communes du Roissy Pays de France. Vous êtes à un quart d\'heure de l\'aéroport Charles de Gaulle : le transfert est à 59 € en tarif fixe garanti, annoncé avant la réservation. Disponible 24h/24, y compris pour les vols avant 6h.',
    prix: '59€ fixe vers CDG',
    duree: '12–18 min vers CDG',
    zones: [
      { nom: 'Goussainville', cp: '95190', km: 0 },
      { nom: 'Fontenay-en-Parisis', cp: '95190', km: 2.9 },
      { nom: 'Bouqueval', cp: '95720', km: 3.0 },
      { nom: 'Louvres', cp: '95380', km: 3.1 },
      { nom: 'Le Plessis-Gassot', cp: '95720', km: 3.9 },
      { nom: 'Châtenay-en-France', cp: '95190', km: 4.3 },
      { nom: 'Puiseux-en-France', cp: '95380', km: 5.1 },
      { nom: 'Épiais-lès-Louvres', cp: '95380', km: 5.8 },
      { nom: 'Villeron', cp: '95380', km: 6.0 },
      { nom: 'Mareil-en-France', cp: '95850', km: 6.1 },
      { nom: 'Chennevières-lès-Louvres', cp: '95380', km: 6.1 },
      { nom: 'Le Mesnil-Aubry', cp: '95720', km: 6.2 },
      { nom: 'Jagny-sous-Bois', cp: '95850', km: 6.4 },
      { nom: 'Marly-la-Ville', cp: '95670', km: 6.6 },
      { nom: 'Villiers-le-Sec', cp: '95720', km: 8.1 },
      { nom: 'Vémars', cp: '95470', km: 8.3 },
      { nom: 'Fosses', cp: '95470', km: 8.6 },
      { nom: 'Saint-Witz', cp: '95470', km: 8.9 },
      { nom: 'Survilliers', cp: '95470', km: 10.6 },
      { nom: 'Plailly', cp: '60128', km: 12.1 },
      { nom: 'Mortefontaine', cp: '60128', km: 14.3 },
    ],
    faq: [
      { q: 'Combien coûte un VTC de Goussainville vers l\'aéroport CDG ?', a: '59 € en berline, tarif fixe garanti. Le montant est annoncé avant la réservation et ne bouge plus : ni compteur, ni supplément pour les bouchons, ni majoration de nuit ou de week-end. Le même prix s\'applique depuis Louvres, Fosses, Survilliers, Marly-la-Ville, Saint-Witz, Vémars et toutes les communes listées ci-dessus.' },
      { q: 'Combien de temps pour rejoindre CDG depuis Goussainville ?', a: 'Environ 13 minutes pour 17 km. Depuis Louvres comptez 12 minutes, depuis Fosses 16 minutes, depuis Marly-la-Ville 18 minutes. C\'est l\'un des secteurs les plus proches de l\'aéroport que nous desservons — plus proche que Chantilly.' },
      { q: 'Desservez-vous Orly et Paris depuis le Pays de France ?', a: 'Oui. Orly est à 45 à 50 minutes pour un forfait de 139 €, Paris centre à environ 50 minutes pour 119 €. Ces deux prix sont également fixes et garantis avant la réservation.' },
      { q: 'Et pour l\'aéroport de Beauvais-Tillé ?', a: 'Beauvais-Tillé est à l\'opposé, entre 61 et 81 km selon votre commune. Il n\'y a donc pas de forfait : le prix est calculé à la distance réelle depuis votre adresse et affiché avant la réservation. Comptez de l\'ordre de 115 à 140 € en berline.' },
      { q: 'Prenez-vous les vols très tôt le matin ?', a: 'Oui, 24h/24. Un départ à 4h du matin pour un vol de 6h ne pose aucun problème et coûte le même prix qu\'en journée — aucune majoration de nuit n\'est appliquée. Le chauffeur vient vous chercher à votre adresse.' },
      { q: 'Couvrez-vous Plailly et Mortefontaine, dans l\'Oise ?', a: 'Oui. Bien qu\'elles soient dans l\'Oise (60), Plailly et Mortefontaine appartiennent au même secteur tarifaire : CDG à 59 €. Plailly est notamment la commune du Parc Astérix.' },
    ],
  },
  'vtc-clermont': {
    slug: 'vtc-clermont',
  ...
  'vtc-aeroport-charleroi': {
    ...
    metaTitle: 'VTC Aéroport de Charleroi depuis l\'Oise dès 459€ | Owise',
    metaDesc: 'Chauffeur privé depuis Compiègne, Senlis, Chantilly, Creil, Beauvais et l\'Oise vers l\'aéroport de Charleroi (Bruxelles Sud), hub Ryanair. Tarif fixe garanti, prise en charge à domicile, disponible 24h/24.',
    keywords: [
      ...
      'vtc compiègne charleroi','vtc senlis charleroi','vtc beauvais charleroi',
    ],
    h1: 'VTC vers l\'Aéroport de Charleroi (Bruxelles Sud)',
    intro: 'Votre chauffeur privé depuis Compiègne, Senlis, Chantilly, Creil, Beauvais, Gouvieux, Lamorlaye et toute l\'Oise vers l\'aéroport de Charleroi (Bruxelles Sud), le hub belge de Ryanair. De nombreux habitants de l\'Oise y trouvent des vols moins chers que depuis CDG ou Orly pour l\'Europe du Sud et de l\'Est. Tarif fixe garanti, chauffeur professionnel, prise en charge à domicile. Disponible 24h/24, 7j/7.',
    prix: 'dès 459€',
    duree: '2h05–2h50 selon votre départ',
    faq: [
      { q: 'Quel est le tarif d\'un VTC vers l\'aéroport de Charleroi selon ma ville de départ ?', a: 'Le forfait est de 459€ en berline depuis Compiègne, 503€ depuis Senlis, 513€ depuis Creil, 525€ depuis Chantilly et 540€ depuis Beauvais — prix fixe garanti, quelle que soit la circulation. Obtenez votre estimation exacte avec notre calculateur en ligne.' },
      ...
      { q: 'Depuis quelle ville de l\'Oise le trajet vers Charleroi est-il le moins cher ?', a: 'Depuis Compiègne, qui est la ville de l\'Oise la plus proche de la frontière belge sur cet axe — environ 211 km contre 248 km depuis Chantilly. C\'est aussi la ville la plus rapide, avec un trajet d\'environ 2h05 contre 2h35 depuis Chantilly.' },
      { q: 'Combien de temps dure le trajet vers Charleroi ?', a: 'Comptez environ 2h05 depuis Compiègne, 2h20 depuis Senlis, 2h30 depuis Creil, 2h35 depuis Chantilly et 2h40 depuis Beauvais, selon le trafic sur l\'A1/A16 puis la E42 en Belgique. Votre chauffeur calcule le départ pour vous déposer confortablement avant l\'enregistrement.' },
  ...
  'vtc-aeroport-bruxelles': {
    ...
    metaTitle: 'VTC Aéroport de Bruxelles depuis l\'Oise dès 539€ | Owise',
    metaDesc: 'Chauffeur privé depuis Compiègne, Senlis, Chantilly, Creil, Beauvais et l\'Oise vers l\'aéroport de Bruxelles-Zaventem. Tarif fixe garanti, prise en charge à domicile, disponible 24h/24.',
    keywords: [
      ...
      'vtc compiègne bruxelles','vtc senlis bruxelles','vtc beauvais bruxelles',
    ],
    h1: 'VTC vers l\'Aéroport de Bruxelles-Zaventem',
    intro: 'Votre chauffeur privé depuis Compiègne, Senlis, Chantilly, Creil, Beauvais, Gouvieux, Lamorlaye et toute l\'Oise vers l\'aéroport de Bruxelles-Zaventem. Correspondances long-courrier, vols Brussels Airlines ou simplement une alternative aux aéroports parisiens. Tarif fixe garanti, chauffeur professionnel, prise en charge à domicile. Disponible 24h/24, 7j/7.',
    prix: 'dès 539€',
    duree: '2h20–3h05 selon votre départ',
    faq: [
      { q: 'Quel est le tarif d\'un VTC vers l\'aéroport de Bruxelles selon ma ville de départ ?', a: 'Le forfait est de 539€ en berline depuis Compiègne, 584€ depuis Senlis, 593€ depuis Creil, 606€ depuis Chantilly et 620€ depuis Beauvais — prix fixe garanti, quelle que soit la circulation. Obtenez votre estimation exacte avec notre calculateur en ligne.' },
      { q: 'Combien de temps dure le trajet vers Bruxelles-Zaventem ?', a: 'Comptez environ 2h20 depuis Compiègne, 2h40 depuis Senlis, 2h50 depuis Creil, 2h55 depuis Chantilly et 3h00 depuis Beauvais, selon le trafic sur l\'A1/A16 puis le ring de Bruxelles. Votre chauffeur ajuste l\'heure de départ pour un enregistrement serein.' },
      ...
      { q: 'Desservez-vous aussi l\'aéroport de Charleroi ?', a: 'Oui, avec un tarif dédié — Charleroi est plus proche de l\'Oise et le prix y est en conséquence plus bas. Consultez notre page VTC Aéroport de Charleroi pour le détail.' },
...
export async function generateMetadata({ params }: { params: Promise<{ destination: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: 'fr_FR',
      siteName: 'Owise',
      images: [{ url: `${BASE}/brand_assets/hero-paris-night.webp`, width: 1920, height: 1080, alt: dest.title }],
    },
    twitter: {
      card: 'summary_large_image',
      title: dest.metaTitle,
      description: dest.metaDesc,
      images: [`${BASE}/brand_assets/hero-paris-night.webp`],
    },
  }
}

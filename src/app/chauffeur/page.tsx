...
export default async function ChauffeurPage() {
  ...
  // `etapes` fait partie de la liste : l'application sait afficher les arrêts,
  // mais la requête les oubliait — le chauffeur partait donc sans savoir qu'un
  // arrêt était prévu, alors que le client l'avait payé.
  const COURSE_FIELDS = 'id, statut, adresse_depart, adresse_arrivee, etapes, date_prevue, nb_passagers, type_vehicule, notes, prix_estime, prix_final, paiement_a_bord, prix_chauffeur, client_id, passager_prenom, passager_nom, passager_tel'

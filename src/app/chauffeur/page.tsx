...
export default async function ChauffeurPage() {
  ...
  const COURSE_FIELDS = 'id, statut, adresse_depart, adresse_arrivee, date_prevue, nb_passagers, type_vehicule, notes, prix_estime, prix_final, paiement_a_bord, client_id, passager_prenom, passager_nom, passager_tel'

...
const icons: Record<string, React.ReactNode> = {
  ...
  calendar:  <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><rect x="3" y="4" width="18" height="18" rx="2"/><path strokeLinecap="round" strokeLinejoin="round" d="M16 2v4M8 2v4M3 10h18"/></svg>,
  ...
  tag:       <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>,
}
...
export default function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      boxShadow: '1px 0 0 rgba(0,0,0,.04)',
    }}>
      {/* Gold line top */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: '0 4px 12px rgba(201,168,76,.2)', flexShrink: 0,
        }}>O</div>
        <div>
          <div style={{
            fontFamily: 'var(--font-cormorant), Georgia, serif',
            fontSize: 19, fontWeight: 500,
            letterSpacing: '.08em', color: C.t1,
          }}>OWISE</div>
          <div style={{ fontSize: 9, letterSpacing: '.16em', textTransform: 'uppercase', color: C.t3 }}>
            Admin
          </div>
        </div>
      </div>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    color: isOn ? C.gold : C.t2,
                    background: isOn ? C.goldBg : 'transparent',
                    textDecoration: 'none',
                    position: 'relative',
                ...
                >
                  {isOn && (
                    <div style={{
                      ...
                      width: 3, height: 18,
                      background: C.gold, borderRadius: '0 2px 2px 0',
                    }} />
                  )}
                  <span style={{ color: isOn ? C.gold : C.t3 }}>{icons[item.icon]}</span>
                  {item.label}
                </Link>
              )
            })}
